...
PropIntegerEditor::PropIntegerEditor(PObject *obj, PProperty *prop)
...
PropIntegerEditor::~PropIntegerEditor(void)
{
...
status_t
PropIntegerEditor::SetProperty(PObject *obj, PProperty *prop)
{
...
void
PropIntegerEditor::SetTarget(BHandler *handler, BLooper *looper)
{
	delete fMsgr;
...
bool
PropIntegerEditor::HandlesType(const BString &type)
{
	return (type.ICompare("IntProperty") == 0);
}


PropertyEditor *
PropIntegerEditor::CreateInstance(PObject *obj, PProperty *prop)
{
	// This is for child classes to implement
	return new PropIntegerEditor(obj,prop);
}


void
PropIntegerEditor::AttachedToWindow(void)
{
...
void
PropIntegerEditor::MessageReceived(BMessage *msg)
{
	switch (msg->what)
	{
		case M_EDIT:
