 ...
 * Original authors: jonas.sundstrom@kirilla.com
...
GenericThread::ThreadFunction(void)
{
	...
	while (1) {
		...
		// TODO should we yield here rather than sleep in the subclass?
		//      This affects the monitoring parent thread rather than
		//      the wrapper child process in the pthread
	}
