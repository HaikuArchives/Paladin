...
cd ../../Tests
g++ Main.cpp ProjectTests.cpp ../Paladin/\(Objects.Paladin\)/paladin.a -o ./tests.o -Wall -lUnitTest++ -I../Paladin -I../Paladin/SourceControl -I../Paladin/BuildSystem -I../Paladin/ThirdParty -lbe -lstdc++ -llocalestub
