...
int32_t PMenuSupermenu(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuFindItem(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuSuperitem(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuRemoveItems(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuSubmenuAt(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuAddItem(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuAddMenu(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuAddSeparator(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuRemoveItem(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuItemAt(void *pobject, void *in, void *out, void *ptr = NULL);
int32_t PMenuRemoveItemAt(void *pobject, void *in, void *out, void *ptr = NULL);
...
PMenu::InitMethods(void)
{
	...
	pmi.AddArg("id", B_INT64_TYPE, " object ID of the menu item to add", 0);
	pmi.AddArg("index", B_INT32_TYPE, " index to place the item at", 0);
	pmi.AddReturnValue("success", B_BOOL_TYPE, " true if the call succeeded");
	...
	pmi.AddArg("command", B_INT32_TYPE, " Value of the what field of the menu item's message", 0);
	pmi.AddReturnValue("id", B_INT64_TYPE, " Object ID of the menu item");
	AddMethod(new PMethod("FindItem", PMenuFindItem, &pmi));
	pmi.MakeEmpty();

	pmi.AddArg("index", B_INT32_TYPE, " Index of the menu item to find", 0);
	pmi.AddReturnValue("success", B_BOOL_TYPE, " true if the call succeeded");
	AddMethod(new PMethod("ItemAt", PMenuItemAt, &pmi));
	pmi.MakeEmpty();

	pmi.AddArg("id", B_INT64_TYPE, " object ID of the item or menu to remove", 0);
	pmi.AddReturnValue("success", B_BOOL_TYPE, " true if the call succeeded");
	AddMethod(new PMethod("RemoveItem", PMenuRemoveItem, &pmi));
	pmi.MakeEmpty();

	pmi.AddArg("index", B_INT32_TYPE, " Index of the first menu item to remove", 0);
	pmi.AddReturnValue("success", B_BOOL_TYPE, " true if the call succeeded");
	...
	pmi.AddArg("delete", B_BOOL_TYPE, " True if the items should be deleted after removal", 0);
	pmi.AddReturnValue("success", B_BOOL_TYPE, " true if the call succeeded");
	AddMethod(new PMethod("RemoveItems", PMenuRemoveItems, &pmi));
	pmi.MakeEmpty();

	pmi.AddArg("index", B_INT32_TYPE, " Index of the menu to find", 0);
	pmi.AddReturnValue("success", B_BOOL_TYPE, " true if the call succeeded");
	AddMethod(new PMethod("SubmenuAt", PMenuSubmenuAt, &pmi));
	pmi.MakeEmpty();

	pmi.AddReturnValue("id", B_INT64_TYPE, " object ID of the submenu, if there is one.");
...
int32_t
PMenuAddItem(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
...
int32_t
PMenuAddMenu(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
...
int32_t
PMenuAddSeparator(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
	...
	outValue1 = backend->AddSeparatorItem();
...
int32_t
PMenuFindItem(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
...
int32_t
PMenuItemAt(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
...
int32_t
PMenuRemoveItem(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
...
int32_t
PMenuRemoveItemAt(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
...
int32_t
PMenuRemoveItems(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
...
int32_t
PMenuSubmenuAt(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
...
int32_t
PMenuSuperitem(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
...
int32_t
PMenuSupermenu(void *pobject, void *in, void *out, void *extraData)
{
	if (!pobject || !in || !out)
		return B_ERROR;
